...
<head>
  ...
  <link 
      rel="stylesheet" 
      href="<?=base_url('assets/adminlte/tempusdominus-bootstrap-4/css/tempusdominus-bootstrap-4.min.css');?>">
  ...
  <link 
      rel="stylesheet" 
      href="<?=base_url('assets/adminlte/plugins/jgvmap/jgvmap.min.css');?>">
...
<span class="d-block text-white"><?= $this->session->userdata('nama'); ?></span>
...
<nav class="mt-2">
  <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu">
    ...
    <li class="nav-item">
      <a href="<?= base_url('admin/kelola_pasien'); ?>" class="nav-link">
...
<?php elseif ($this->session->userdata('role') == 'pasien'): ?>
    <!-- MENU PASIEN -->
    <li class="nav-item">
      <a href="<?= base_url('pasien/daftar'); ?>" class="nav-link">
